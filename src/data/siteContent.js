...
export const serviceCategories = [
  {
    ...
    accent: '#C9A24E',
    services: [
      'Hair Cut', 'Hair Wash', 'Hair Spa', 'Hair Styling',
      'Hair Coloring', 'Global Hair Color', 'Root Touch-Up',
      'Highlights', 'Keratin Treatment', 'Hair Botox',
      'Smoothening', 'Straightening', 'Rebonding', 'Hair Extensions',
    ],
  ...
  },
  {
    ...
    accent: '#E3C98A',
    services: [
      'Cleanup', 'Gold Facial', 'Diamond Facial', 'Hydra Facial',
      'Detan Treatment', 'Anti-Aging Facial', 'Skin Brightening',
      'Acne Treatment', 'Glow Treatment',
    ],
  ...
  },
  {
    ...
    accent: '#F6ECEC',
    services: [
      'Threading', 'Waxing', 'Rica Wax', 'Full Body Wax',
      'Bleach', 'Manicure', 'Pedicure', 'Body Polishing',
    ],
  ...
  },
  {
    ...
    services: [
      ...
      'Pre Bridal Packages', 'Saree Draping', 'Hair Styling',
    ],
  ...
  },
  {
    ...
    accent: '#C9A24E',
    services: [
      'Nail Extensions', 'Gel Polish', 'Nail Art', 'French Nails',
      'Refill', 'Removal', 'Luxury Nail Designs',
    ],
...
export const gallery = {
  ...
  categories: ['All', 'Salon Interior', 'Hair', 'Bridal', 'Skin', 'Nails'],
  items: [
    { id: 1, src: salon1, alt: 'Golden Sparsh Salon Interior - Styling Station', category: 'Salon Interior', tag: 'Interior' },
    { id: 2, src: salon2, alt: 'Golden Sparsh Salon - Premium Hair Wash Station', category: 'Salon Interior', tag: 'Interior' },
  ],
}
